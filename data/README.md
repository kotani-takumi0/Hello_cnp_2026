...
**共有ドライブ側の配置（Colabの `notebooks/colab_runner.ipynb` はこの想定）**:
`マイドライブ/signate_cup_2026/data/` に下記ファイルを置く。共有フォルダで受け取った場合は、
**マイドライブにショートカットを追加**すること（そうしないとColabからパスが通らない）。
